...
def load_retest_bundle(
    ...
    if release.manifest.get("revision") != "12.0.0" or release.protocol.get("revision") != "2.0.0":
        raise ValueError("the current formal evidence release must be the explicit 12.0.0 retest")
