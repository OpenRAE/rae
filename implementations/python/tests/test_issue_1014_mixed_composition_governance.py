...
DELIVERY_PATHS = {
    ...
    "docs/research/formal-semantic-validation/bundles/retest-v31.json",
    "docs/research/formal-semantic-validation/execution-snapshot-v31.json",
    "docs/research/specification-coverage/analysis-v31.json",
    "docs/research/specification-coverage/bundles/raes-standardized-specification-coverage-issue-1183-v31.json",
    "docs/research/specification-coverage/execution-snapshot-v31.json",
    ...
    "implementations/python/packages/raes_contracts/contracts/mixed_composition_validation.py",
