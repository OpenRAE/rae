...
- [`execution-snapshot-v36.json`](execution-snapshot-v36.json) and
  ...
  replay binds issue #1016 mixed-runtime coordination to the exact source
  state. The retained language corpus does not execute mixed providers or
  establish backend-native realization, interoperability, IFC, or equivalence.
