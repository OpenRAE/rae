...
- [`execution-snapshot-v27.json`](execution-snapshot-v27.json) and
  ...
  names, and selected systemd-state contract to exact source and package
  digests. Classifications and claim limits remain unchanged; no live service
  manager or backend execution is evaluated by this corpus.
