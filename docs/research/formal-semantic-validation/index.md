...
- [`bundles/retest-v25.json`](bundles/retest-v25.json) is current release 26.0.0.
  ...
  [`analysis-v25.json`](analysis-v25.json) to issue #1299 partial runtime
  listener admission. Fresh production and participant replay retains
  release-25 outcomes, digests, and claim limits; endpoint completeness and
  backend admission remain outside this corpus's claims.
