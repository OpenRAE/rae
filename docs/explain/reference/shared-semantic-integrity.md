...
| Modular participant-control profiles, extensible dynamic IFC and governed effect composition (published semantics; executable realization separate) | SEM-235 | validation, execution, observation | `specs/formal/participant-semantics/modular-participant-control.md`, `implementations/python/tests/sem235_modular_control_model.py`, `implementations/python/tests/test_sem_235_modular_control.py` | partial |
