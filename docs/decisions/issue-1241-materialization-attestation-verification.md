...
The merge retains the published coverage release 16.0.0 and formal release
18.0.0 from `dev`. Fresh execution captures the combined implementation in
coverage release 17.0.0 and formal release 19.0.0, with explicit compiler-digest
deviations and unchanged bounded outcomes. The historical no-replay regression
also covers formal release 18.0.0. Archived shape and computed integrity checks
...
release's baseline mapping and rejects a substituted baseline, including release 19.
