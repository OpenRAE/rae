...
- IMPLEMENTS → DOCUMENTATION `docs/research/specification-coverage/index.md` (Release 25.0.0 capture republished against the issue #1223 implementation digest)
- IMPLEMENTS → DOCUMENTATION `docs/research/formal-semantic-validation/index.md` (Release 26.0.0 retest republished against the issue #1223 implementation digest)
