...
- DOCUMENTS → DOCUMENTATION `docs/research/formal-semantic-validation/bundles/retest-v17.json` (Fresh bounded production replay of the integrated issue-1237 source state)
- DOCUMENTS → DOCUMENTATION `docs/research/specification-coverage/bundles/raes-standardized-specification-coverage-issue-1237-v16.json` (Fresh source-bound coverage replay retains existing claim limits)
