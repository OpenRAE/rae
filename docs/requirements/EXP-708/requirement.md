...
- DOCUMENTS → DOCUMENTATION `docs/research/formal-semantic-validation/bundles/retest-v16.json` (Fresh bounded production replay of the issue-1237 source state)
- DOCUMENTS → DOCUMENTATION `docs/research/specification-coverage/bundles/raes-standardized-specification-coverage-issue-1237-v15.json` (Fresh source-bound coverage replay retains existing claim limits)
