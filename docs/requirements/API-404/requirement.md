...
- IMPLEMENTS → CODE_FILE `implementations/python/packages/raes_runtime/control_plane_store.py` (Actor-bound atomic terminal commits with explicit snapshot-bearing and operation-only modes)
